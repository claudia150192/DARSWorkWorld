...
# Create questions
Question.delete_all
@CurrentDate                              = Question.new(:display_rules => 'always', :default_answer => '12/01/2010',      :reference_id =>   '',    :question_type => 'not_question', :answer_choices => '',                          :order => 1 ,    :group_id => @startup.id)
...
@SitDate                                  = Question.new(:display_rules => 'always', :default_answer => '12/25/2010',                  :reference_id =>   '5',   :question_type => 'date_time',    :answer_choices => '',                          :order => 3 ,    :group_id => @startup.id)
