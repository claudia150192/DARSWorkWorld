class AddNewAuxiliaryGrantWebcalcs2 < ActiveRecord::Migration
...
def self.up
 ...
 def self.down
      ...
      @RateVaMaxAuxiliaryGrantCoupleElsewhere  = WebCalc.find_by_name('RateVaMaxAuxiliaryGrantCoupleElsewhere')
      @RateVaMaxAuxiliaryGrantCoupleElsewhere.delete unless @RateVaMaxAuxiliaryGrantCoupleElsewhere.blank?

      @RateVaMaxAuxiliaryGrantElsewhere  = WebCalc.find_by_name('RateVaMaxAuxiliaryGrantElsewhere')
      @RateVaMaxAuxiliaryGrantElsewhere.delete unless @RateVaMaxAuxiliaryGrantElsewhere.blank?

      @RateVaMaxAuxiliaryGrantCouplePd8  = WebCalc.find_by_name('RateVaMaxAuxiliaryGrantCouplePd8')
      @RateVaMaxAuxiliaryGrantCouplePd8.delete unless @RateVaMaxAuxiliaryGrantCouplePd8.blank?

      @RateVaMaxAuxiliaryGrantPd8  = WebCalc.find_by_name('RateVaMaxAuxiliaryGrantPd8')
      @RateVaMaxAuxiliaryGrantPd8.delete unless @RateVaMaxAuxiliaryGrantPd8.blank?
   end
